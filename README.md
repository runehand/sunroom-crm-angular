...
A full-featured customer relationship management application built with Angular 21, Angular Material, and Chart.js. This is the Angular frontend for Sunroom CRM, backed by a .NET 8 REST API with SQL Server.
...
|------------|------------|-------------|
| [sunroom-crm-dotnet](https://github.com/runehand/sunroom-crm-dotnet) | .NET 8, EF Core, SQL Server | Shared REST API with JWT auth, AI endpoints, and Docker support |
| **sunroom-crm-angular** (this repo) | Angular 21, Material, Vitest | Angular frontend with 100% test coverage |
| [sunroom-crm-react](https://github.com/runehand/sunroom-crm-react) | React, TypeScript | React frontend |
| [sunroom-crm-vue](https://github.com/runehand/sunroom-crm-vue) | Vue 3, TypeScript | Vue frontend |
| [sunroom-crm-blazor](https://github.com/runehand/sunroom-crm-blazor) | Blazor, .NET 8 | Blazor WebAssembly frontend |
| [sunroom-crm-laravel](https://github.com/runehand/sunroom-crm-laravel) | Laravel, PHP | Laravel full-stack implementation |
...
- Node.js 24+ (LTS)
- npm 11+
- The [.NET API](https://github.com/runehand/sunroom-crm-dotnet) running on `http://localhost:5236`

### Setup

```bash
git clone https://github.com/runehand/sunroom-crm-angular.git
